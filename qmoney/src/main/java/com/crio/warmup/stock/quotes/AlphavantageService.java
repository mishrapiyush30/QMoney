...
public class AlphavantageService implements StockQuotesService {
  ...
  public List<Candle> getStockQuote(String symbol, LocalDate from, LocalDate to) 
    ...
    try {
      ...
      throw new JsonProcessingException("Json processing error") {};
    }
    ...
    if (response != null) {
      try {
        ...
        throw new StockQuoteServiceException("Stock Quote invalid");
      }
    } else {
      throw new StockQuoteServiceException("Stock Quote invalid");
    }
    candleList.sort(getComparator());
    return candleList;
  }
  ...
  protected String buildUri(String symbol) {
    String uriTemplate = "https://www.alphavantage.co/" 
        + "query?function=TIME_SERIES_DAILY&apikey=F4YGQ47V87IREVQ3&outputsize=full&symbol=" 
        + symbol;
    return uriTemplate;  
  }
